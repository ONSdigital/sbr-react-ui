...
const HomeSearchForm = (props) => (
  <form className="form">
    <TextInput labelClass="label__description" autoFocus legend="Reference number" id="Id" size="u-mb-s" onChange={props.onChange} type="bi-search-input" label="ERN, LURN, UBRN, CRN, VAT or PAYE" value={props.query} />
