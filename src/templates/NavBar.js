          ...
          <div className="wrapper nav-main--hidden" id="nav-primary">
            <ul className="primary-nav__list">
              ...
              <li className="primary-nav__item js-nav js-expandable ">
                <a className="primary-nav__link col col--md-8 col--lg-10" href="/economy" aria-haspopup="true">placeholder</a>
                <ul className="primary-nav__child-list col col--md-16 col--lg-20 js-expandable__content js-nav-hidden jsEnhance" aria-expanded="false" aria-label="submenu">
                  <li className="primary-nav__child-item  js-expandable__child">
                    <a className="primary-nav__child-link" tabIndex="-1" href="/economy/economicoutputandproductivity" >collapsed placeholder</a>
                  </li>
                  <li className="primary-nav__child-item  js-expandable__child">
                    <a className="primary-nav__child-link" tabIndex="-1" href="/economy/governmentpublicsectorandtaxes" >collapsed placeholder</a>
                  </li>
                </ul>
              </li>
            </ul>
